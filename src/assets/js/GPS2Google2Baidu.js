...
GPS2Google2Baidu.WGS_84_to_GCJ_02 = GPS2Google2Baidu.gcj_encrypt;
GPS2Google2Baidu.GCJ_02_to_WGS_84 = GPS2Google2Baidu.gcj_decrypt_exact;
GPS2Google2Baidu.GCJ_02_to_BD_09 = GPS2Google2Baidu.bd_encrypt;
GPS2Google2Baidu.BD_09_to_GCJ_02 = GPS2Google2Baidu.bd_decrypt;
GPS2Google2Baidu.BD_09_to_WGS_84 = function (lat, lng) {
    var b2c = this.BD_09_to_GCJ_02(lat, lng);
    return this.GCJ_02_to_WGS_84(b2c.lat, b2c.lng);
}
GPS2Google2Baidu.WGS_84_to_BD_09 = function (lat, lng) {
    var w2c = this.WGS_84_to_GCJ_02(lat, lng);
    return this.GCJ_02_to_BD_09(w2c.lat, w2c.lng);
}
export default GPS2Google2Baidu;