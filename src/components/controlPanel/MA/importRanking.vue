    ...
    <div class="import_content">
      ...
      >
        ...
        <div class="el-upload__tip" slot="tip" style="color: #909399;">
          <el-tag size="small">
            <el-link style="font-size: 12px;" :underline="false" :href="exampleXlsPath">示例文件下载</el-link>
          </el-tag>
          <br />请先输入年份, 方可导入。
...
import { importExcelForRanking } from "@/data/layerExcelIO";
...
export default {
  ...
  methods: {
    ...
    uploadExcel() {
      ...
      this.uploading = true;
      importExcelForRanking(formData)
        .then(res => {
          this.uploading = false;
          this.$refs.upload.clearFiles();
          this.ishasFile = false;
