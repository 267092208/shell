<template>
  <div class="ctl-panel-container">
                  ...
                  <el-dropdown class="label-dropdown">
                    ...
                    <el-dropdown-menu slot="dropdown">
                      <el-dropdown-item
                        ...
                        :key="index"
                        @click.native="choiceScale(item, 'nti')"
    ...
    <import-layer-ctrl :dialogVisible.sync="importLayerCtrlVisible" exampleXlsPath="./dataPages/gsyz/gsyz-import-test.xlsx"></import-layer-ctrl>
  </div>
</template>
