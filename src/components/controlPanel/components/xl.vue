            ...
            <div class="tab-panel-group">
              <el-row type="flex">
                ...
                >
                  ...
                  <el-avatar shape="square" :size="50" fit="fill" class="iconfont icon-recall icon"></el-avatar>
                </el-row>
                <el-row
                  type="flex"
                  justify="center"
                ...
                >
                  ...
                  <el-avatar shape="square" :size="50" fit="fill" class="iconfont icon-layer icon"></el-avatar>
                </el-row>
              </el-row>
...
export default {
  ...
  methods: {
    ...
    async beginDrawRoad() {
      ...
      let geometry = await this.$store
        .dispatch("getGeometry", { drawMode: "LineString" })
