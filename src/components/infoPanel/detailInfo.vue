...
<script>
import baseInfoItem from "@/components/infoPanel/common/baseInfoItem";
...
export default {
    ...
    activated() {
      ...
      let index = this.current
        ...
        document.querySelector(".detail-info").scrollTop = targetTop;
    },
    deactivated() {
    ...
    methods: {
        ...
        scrollTo(index) {
            ...
            const targetOffsetTop =
                ...
                document.querySelector(`.detail-item:nth-child(${index + 1})`)
                    .offsetTop;
    ...
    watch: {
        ...
        selectFeature(val) {
            if (val) {
                this.current = 0;
                this.$refs.detailInfo.scrollTop = 0;
            }
        }
    }
};
