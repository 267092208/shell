...
// 为每个图层定义模型类，添加属性成员
// for (let p in fields) {
//     const modelClass = function (o) { Object.assign(this, o); }
//     const fs = fields[p];
//     for (let f of fs.filter(t => t.get || t.set)) {
//         Object.defineProperty(modelClass.prototype, f.fieldName, {
//             get: f.get,
//             set: f.set
//         });
//     }
//     fs.modelClass = modelClass;
// }
...
function IsYcShell (rowData) {
    return rowData["品牌"].toLowerCase() == "yc shell";
}
