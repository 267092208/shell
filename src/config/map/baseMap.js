...
const baseMapRasterSource = {
  ...
  天地图影像: [
    ...
    {
      source: new XYZ({
        url: 'https://t{0-7}.tianditu.gov.cn/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk=c26cf19d1e197d4fc55c61f2ce9aae4b',
        attributions: '&copy 星罗地图 | TileData-天地图-GS(2019)1719号',
        maxZoom: 18, //默认18
        minZoom: 0,
        // projection: 'EPSG:4326'
  ...
  百度影像: [
    {
      source: new DB09TileSource({
        url: 'http://shangetu{1-4}.map.bdimg.com/it/u=x={x};y={y};z={z};v=009;type=sate&fm=46',
        attributions: '&copy 星罗地图 | TileData-Baidu-GS(2019)5218号',
        maxZoom: 19, //默认18
        minZoom: 3, //默认0
        projection: 'EPSG:3857' //坐标系
    ...
    {
      source: new DB09TileSource({
        url: 'http://online{1-4}.map.bdimg.com/tile/?qt=tile&x={x}&y={y}&z={z}&styles=sl&v=020',
        attributions: '&copy 星罗地图 | TileData-Baidu-GS(2019)5218号',
        maxZoom: 19, //默认18
        minZoom: 3, //默认0
        projection: 'EPSG:3857' //坐标系
